...
export const ACTION_CONTEXT_MAP: Record<string, AgentContext[]> = {
	...
	START_CODING_TASK: ["general", "code", "automation"],
	...
	SPAWN_AGENT: ["general", "code", "automation"],
	SEND_TO_AGENT: ["general", "code", "automation"],
	LIST_AGENTS: ["code", "automation"],
	STOP_AGENT: ["code", "automation"],
	TASK_HISTORY: ["general", "code", "automation"],
	TASK_CONTROL: ["general", "code", "automation"],
	TASK_SHARE: ["general", "code", "automation"],
	...
	RELATIONSHIP: ["character", "social", "lifeops", "knowledge"],
	CALENDAR: ["automation", "social", "lifeops"],
	CHECKIN: ["automation", "lifeops"],
	PROFILE: ["character", "social", "lifeops"],
	...
	SERVER_INFO: ["social"],
	VOICE_CALL: ["phone", "social", "lifeops"],
	LIFE: ["lifeops"],
	COMPUTER_USE: ["lifeops", "browser", "system"],
	COMPUTE_TRAVEL_BUFFER: ["lifeops"],
	BOOK_TRAVEL: ["lifeops"],
	SUBSCRIPTIONS: ["lifeops"],
	HEALTH: ["lifeops"],
	SCREEN_TIME: ["lifeops"],
	WEBSITE_BLOCK: ["lifeops", "automation"],
	APP_BLOCK: ["lifeops", "automation"],
	RESOLVE_REQUEST: ["lifeops"],
	AUTOFILL: ["lifeops", "browser", "settings"],
	PASSWORD_MANAGER: ["lifeops", "settings"],
	DEVICE_INTENT: ["lifeops", "automation"],
	CHAT_THREAD: ["lifeops", "social"],
	PAYMENTS: ["lifeops"],
	X: ["lifeops", "social"],
	CONNECTOR: ["lifeops", "connectors"],
	TOGGLE_FEATURE: ["lifeops", "settings"],
