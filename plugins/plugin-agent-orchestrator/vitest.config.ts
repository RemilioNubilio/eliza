...
export default defineConfig({
  test: {
    ...
    include: [
      ...
      "src/__tests__/task-agent-memory.test.ts",
      "src/__tests__/task-workdir-routes.test.ts",
      "src/__tests__/start-coding-task-utils.test.ts",
      ...
      "src/__tests__/pty-session-io.test.ts",
